...
#ifndef REMOTE_ALGORITHM_H
#define REMOTE_ALGORITHM_H
 ...
 */
class RemoteAlgorithm : public AdaptationAlgorithm
{
public:
  RemoteAlgorithm (  const videoData &videoData,
