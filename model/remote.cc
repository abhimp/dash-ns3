...
NS_LOG_COMPONENT_DEFINE ("RemoteAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (RemoteAlgorithm);

RemoteAlgorithm::RemoteAlgorithm (  const videoData &videoData,
...
algorithmReply
RemoteAlgorithm::GetNextRep (const int64_t segmentCounter, int64_t clientId)
{
...
// 	std::cout << response;
	...
	algorithmReply ar = { nextBitrateIndex, delay, timeNow, 0, 0 };
